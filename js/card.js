    ...
    initEvents() {
        ...
        this.onMouseleaveFn = () => this.mouseLeave();
         if (window.matchMedia('(hover: hover)').matches) {
            ...
            // Fallback for quick touch interactions
            this.DOM.el.addEventListener('touchstart', this.onMouseenterFn);
            this.DOM.el.addEventListener('touchend', this.onMouseleaveFn);
        }
    }
